...
const products = [{id: "1", price: 79, name: 'table'},
 {id: "2", price: 75, name: 'chair'}, 
 {id: "3", price: 98, name: 'house'},
 ]

app.get('/', (req, res) => {

res.send(products.map(
    (product) => `<a href="http://localhost:3000/p/${product.id}">${product.name}</a>`
)
.join('')
)
})
